...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown">Doctor Info <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="showDoc.php">All Doctor Info</a></li>                        
                        </ul>                    
                    </li>
    ...
    <div class="row">
                    <div id = "heading" >
                        <h2 style="color:blue"><strong>Doctors</strong><h2>
                    </div>
        </div>
            ...
            <div class="row">
                ...
                $sql="Select concat(m.FIRST_NAME,' ' ,m.MIDDLE_NAME, ' ' ,m.LAST_NAME) AS Name , m.EMAIL_ID , m.PHONE_NUMBER , m.WorkingInstitution , d.Specialist_of FROM members m JOIN doctor d WHERE m.SID = d.SID";
