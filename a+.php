        ...
        <nav class="navbar navbar-default navbar-inverse">
           ...
           <div class="row">
            ...
            <div class="row">
                ...
                $sql="Select concat(m.FIRST_NAME,' ' ,m.MIDDLE_NAME, ' ' ,m.LAST_NAME) AS Name , m.EMAIL_ID , m.PHONE_NUMBER , m.WorkingInstitution , b.Last_Blood_Donation,b.Blood_GROUP FROM members m JOIN blood b WHERE m.SID = b.SID AND(B.Blood_GROUP = 'A+')";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<h1>No Doner Found Who Have A+ Blood.<h1>";
                }
