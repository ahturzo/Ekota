...
<div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown">Post <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="todaypost.php">Today's Post</a></li>
    ...
    <div class="row">
                    <div id = "heading" >
                        <h2 style="color:blue"><strong>Today's POST</strong><h2>
                    </div>
        </div>
        ...
        <div class="row">
                ...
                $sql="Select concat(m.FIRST_NAME,' ' ,m.MIDDLE_NAME, ' ' ,m.LAST_NAME) AS Name , p.TYPE , p.POSTdate , p.POST FROM members m JOIN post p WHERE m.SID = p.SID && POSTdate=$date";
