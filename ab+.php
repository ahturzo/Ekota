...
<div class="container">
    ...
    <div class="row">
        <nav class="navbar navbar-default navbar-inverse">
           ...
           <div class="row">
                    <div id = "heading" >
                        <h2 style="color:blue"><strong>A+ Blood Doner's</strong><h2>
                    </div>
        </div>
            ...
            <div class="row">
                ...
                $sql="Select concat(m.FIRST_NAME,' ' ,m.MIDDLE_NAME, ' ' ,m.LAST_NAME) AS Name , m.EMAIL_ID , m.PHONE_NUMBER , m.WorkingInstitution , b.Last_Blood_Donation,b.Blood_GROUP FROM members m JOIN blood b WHERE m.SID = b.SID AND(B.Blood_GROUP = 'AB+')";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<h1>No Doner Found Who Have AB+ Blood.</h1>";
                }
